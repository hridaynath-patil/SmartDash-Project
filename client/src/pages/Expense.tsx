...
const Expense = () => {
    ...
    return Object.keys(groups)
      .map(key => {
        ...
        return {
          ...
          categoryName: groups[key].categories.join(', ') || 'Expense',
  ...
  const selectedCat = useMemo(() => {
    return expenseCategories.find(c => c._id === categoryId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await addTransaction(title, amt, 'expense', categoryId, date);
    handleClose();
  ...
  return (
    <div style={{ paddingBottom: '2rem', position: 'relative' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        <div>
          <h2 style={{ margin: 0, fontSize: '2rem', fontWeight: 700, color: 'var(--text-main)' }}>Expense Overview</h2>
      ...
      {/* Expense list section (matches image 2) */}
      <div className="card" style={{ padding: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: 700, color: 'var(--text-main)' }}>All Expenses</h3>
            ...
            {expenseTransactions.map((tx) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  ...
                  {/* Actions */}
                  <div className="expense-delete-btn" style={{ opacity: 0, transition: 'opacity 0.2s' }}>
                    <button 
      ...
      {/* MODAL: Add Expense (matches image 3) */}
      {isModalOpen && (
        <div style={{ 
          position: 'fixed', 
          top: 0, 
          ...
          <div className="card" style={{ 
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              {/* Income Source Input (mockup has this label literally) */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                <label style={{ fontWeight: 600, fontSize: '0.9rem', color: 'var(--text-main)' }}>Income Source</label>
                <input 
                  type="text" 
                  placeholder="e.g. Electric bill, Grocery shopping" 
                  value={title} 
      ...
      <style>{`
        ...
        .expense-card:hover .expense-delete-btn {
          opacity: 1 !important;
        }
      `}</style>
